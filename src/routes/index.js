...
router.get('/', async (req, res) => {
        ...
        for( const player of resultsJSON){
                console.log(`calculating ${player.name}`)
                ...
                const score = hofCalculator(playerData)
...
function hofCalculator(player){
        ...
        if(!player.careerTotals || !player.careerTotals.regularSeason){
                return 0
        }
